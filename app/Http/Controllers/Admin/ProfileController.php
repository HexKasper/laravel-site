       ...
       //  $user->role = $request->role;
        ...
        public function resetPassword(ResetPasswordRequest $request)
        {
            ...
            if (Auth::attempt(['email' => auth()->user()->email, 'password' => $request->password])) {
                ...
                return redirect()->back()->with('user_message', 'Parola a fost modificata cu succes. Noua parola pentru acest cont este <strong>' . 
                $request->passwordnew . '</strong>. <br> Notati aceasta parola intr-un loc sigur.');
            }
        }
 }
