...
class CategoryController extends Controller
{
    ...
    public function addCategory(CategoryAddRequest $request)
    {
      ...
      $category->meta_keywords = $request->meta_keywords;
        ...
        $mess = 'Categoria ' . $request->title . ' a fost inregistrat in baza de date. ';
   ...
   // ===> drepturi editor ===
    ...
    public function deleteCategory($id)
    {
        ...
        $category->delete();
        return redirect(route('admin.categories'))->with('success', 'Categoria ' . $category->title . ' a fost sters definitiv din baza de date');
    }
